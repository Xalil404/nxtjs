'use client'; // Add this if using the app directory and client-side component
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(
                'https://backend-django-9c363a145383.herokuapp.com/api/contact/',
                formData,
                {
                    headers: {
                        ...
                        <div className="mt-5">
                            ...
                            <div className="mt-5">
                                <Link href="/" legacyBehavior>
                                    <a className="btn btn-secondary mx-auto d-block w-50">Back to Home Page</a>
                                </Link>
                            </div>
                        </div>
                    </form>
